...
public class MsgReplaceHoldEntityAction extends BaseEntityAction<MsgReplaceHoldEntity> {
    ...
    public void addReplaceHold(LoginContext user, String fieldTag, String replaceToken, String defaultValue,
    ...
    public MsgReplaceHoldList loadByUser(LoginContext user) {
    ...
    public MsgReplaceHoldList loadByCompany(CrmOrganizationEntity company) {
        Optional<List<MsgReplaceHoldEntity>> all = loadAll();
    ...
    class RowMapperImpl implements RowMapper<MsgReplaceHoldEntity> {
        @Override
