 ...
 * @author hxj
 */
public class SqlMetaParseRule extends AbstractSqlParseRule {

    private static final Logger logger = LoggerFactory.getLogger(SqlMetaParseRule.class);
    ...
    public void end(String namespace, String name) throws Exception {
        ColumnMeta columnMeta = getDigester().pop();
