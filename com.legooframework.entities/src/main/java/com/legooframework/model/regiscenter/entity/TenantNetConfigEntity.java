...
public class TenantNetConfigEntity extends BaseEntity<Long> {
    ...
    private final String webDomain, companyName;

    public TenantNetConfigEntity(Long id, ResultSet res) {
        super(id, res);
        try {
            ...
            this.companyName = ResultSetUtil.getObject(res, "companyName", String.class);
