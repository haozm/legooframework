...
//    }
    ...
    public static List<MsgEntity> createSMSMsg(SendMessageBuilder msgTmp) {
    ...
    private static Optional<MsgEntity> createWx(SendMessageBuilder msgTmp) {
        if (msgTmp.isWxExits()) {
    ...
    private static MsgEntity createSms(SendMessageBuilder msgTmp) {
        if (msgTmp.isOK()) {
