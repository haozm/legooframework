...
public class EWeiShopMemberEntityActionTest {
    ...
    public void findByOpenId() {
        shopMemberEntityAction.findByOpenId("ozIX61YIN6vwLbKz-ioXX5IudrDY").ifPresent(x -> System.out.println(x));
    }


    @Autowired
    EWeiShopMemberEntityAction shopMemberEntityAction;
}