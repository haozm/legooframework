...
public class ParamMeta {
    ...
    private boolean isRfm() { return ColumnType.RFM == this.type;}

    private boolean isDateRange() { return ColumnType.DATERANGE == this.type;}

    private boolean isRange() { return ColumnType.RANGE == this.type;}
