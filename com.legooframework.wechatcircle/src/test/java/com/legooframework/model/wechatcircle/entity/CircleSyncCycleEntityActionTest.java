...
public class CircleSyncCycleEntityActionTest {
    ...
    @Test
    public void update() {
        CircleSyncCycleEntity asd = CircleSyncCycleEntity.createBatchCycle("xiaojie_hao", 1559814094L, 1569898094L);
        action.update(asd);
    }

    @Autowired
    private CircleSyncCycleEntityAction action;
}