...
-- 添加索引
CREATE INDEX ACP_EMPLOYEE_ALLOT_RESULT_COM_SALID_IDX USING BTREE ON acp.ACP_EMPLOYEE_ALLOT_RESULT (company_id,sale_record_id);
CREATE INDEX ACP_EMPLOYEE_ALLOT_RESULT_COM_INFO_IDX USING BTREE ON acp.ACP_EMPLOYEE_ALLOT_RESULT (company_id,store_id,employee_id,member_id);
