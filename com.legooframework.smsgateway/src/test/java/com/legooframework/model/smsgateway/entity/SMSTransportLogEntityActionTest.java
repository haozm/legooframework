...
public class SMSTransportLogEntityActionTest {
    ...
    public void batchInsert() {
        ...
        final SMSSendRuleEntity sendRule = smsSendRuleEntityAction.findByType(businessType);
        ...
        List<SMSTransportLogEntity> alo = Lists.newArrayList();
        sms_list.forEach(x -> {
            alo.add(new SMSTransportLogEntity(store, x, batch, sendRule));
        });
        action.batchAdd4Init(alo);
    }
    ...
    @Autowired
    private SMSTransportLogEntityAction action;
}