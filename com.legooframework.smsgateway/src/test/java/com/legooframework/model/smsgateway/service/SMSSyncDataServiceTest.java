...
public class SMSSyncDataServiceTest {

    @Test
    public void syncBlackList() {
        syncDataService.syncBlackList();
    }

    @Test
    public void syncFinalStates() {
        syncDataService.syncFinalStates();
    }
    ...
    public static void main(String[] args) {
        ...
        app.getBean(SMSSyncDataService.class).syncFinalStates();
    }

    @Autowired
    SMSSyncDataService syncDataService;
}