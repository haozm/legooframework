...
(
  ...
  sms_channel           TINYINT UNSIGNED NOT NULL DEFAULT 0,
  ...
  send_remarks          VARCHAR(1024)    NULL     DEFAULT NULL,
  ...
  reimburse_batchno     VARCHAR(64)      NULL     DEFAULT NULL,
  reimburse_date        DATETIME         NULL,
...
(
  ...
  send_mode    TINYINT UNSIGNED NOT NULL DEFAULT 1,
