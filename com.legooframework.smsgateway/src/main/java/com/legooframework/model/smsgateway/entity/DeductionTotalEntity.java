...
public class DeductionTotalEntity extends BaseEntity<String> {
    ...
    private DeductionTotalEntity(StoEntity store, BusinessType businessType, boolean freeSend, String smsBatchNo,
    ...
    private DeductionTotalEntity(StoEntity store, BusinessType businessType, String smsBatchNo,
                                 long smsQuantity, long wxQuantity, long cteator, SendMode sendMode, String smsContext) {
    ...
    static DeductionTotalEntity createInstance(StoEntity store, SMSSendRuleEntity businessRule, BusinessType businessType,
        ...
        if (businessRule == null)
            return new DeductionTotalEntity(store, businessType, smsBatchNo, smsQuantity, wxQuantity, isAuto ? -1 : user.getLoginId(),
                    sendMode, smsContext);
        return new DeductionTotalEntity(store, businessRule.getBusinessType(), businessRule.isFreeSend(), smsBatchNo,
                smsQuantity, wxQuantity, isAuto ? -1 : user.getLoginId(), sendMode, smsContext);
    }

    DeductionTotalEntity(String id, ResultSet res) {
        super(id, res);
        try {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeductionTotalEntity)) return false;
        DeductionTotalEntity that = (DeductionTotalEntity) o;
