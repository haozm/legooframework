...
public class MsgReplaceHoldEntity extends BaseEntity<Long> {
    ...
    private MsgReplaceHoldEntity(UserAuthorEntity user, String fieldTag, String replaceToken, TokenType tokenType,
                                 String defaultValue, Map<String, String> enumMap) {
        super(0L, user.getTenantId(), user.getId().longValue());
    ...
    static MsgReplaceHoldEntity createString(UserAuthorEntity user, String fieldTag, String replaceToken, String defaultValue) {
        return new MsgReplaceHoldEntity(user, fieldTag, replaceToken, TokenType.STRING, defaultValue, null);
    }

    static MsgReplaceHoldEntity createDate(UserAuthorEntity user, String fieldTag, String replaceToken, String defaultValue) {
        return new MsgReplaceHoldEntity(user, fieldTag, replaceToken, TokenType.DATE, defaultValue, null);
    }

    static MsgReplaceHoldEntity createEnum(UserAuthorEntity user, String fieldTag, String replaceToken, Map<String, String> enumMap) {
    ...
    boolean isMyCompany(UserAuthorEntity user) {
        return this.getTenantId().intValue() == user.getCompanyId();
    }

    boolean isMyCompany(OrgEntity company) {
        return Ints.compare(this.getTenantId().intValue(), company.getId()) == 0;
    }
