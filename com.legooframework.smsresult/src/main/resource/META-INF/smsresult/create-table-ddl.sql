...
CREATE INDEX SMS_SENDING_LOG_MIXING_IDX USING BTREE ON SMS_SENDING_LOG (company_id,store_id);
CREATE INDEX SMS_SENDING_LOG_SEND_MSG_ID_IDX USING BTREE ON SMS_SENDING_LOG (send_msg_id);
